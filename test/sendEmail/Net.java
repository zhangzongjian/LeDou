...
public class Net {
    ...
    public Net(String externalIpProviderUrl) {
    ...
    *//**
    ...
    public static String getOutSideIp(){
        Net fetcher=new Net("http://www.baidu.com");
        return fetcher.getMyExternalIpAddress();
    }
    
    public static String getInSideIp() throws UnknownHostException {
...
//		System.out.println(getOutSideIp());
//		System.out.println(getInSideIp());
